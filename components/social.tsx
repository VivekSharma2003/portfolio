...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/VivekSharma2003",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/vivek-sharma-962710228/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/viveksh1952003",
        icon: Icons.x,
      },
      email: {
        name: "Send Email",
        url: "mailto:viveksh1952003@gmail.com",
        icon: Icons.email,
      },
    },
  },
